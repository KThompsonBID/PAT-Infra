...
xcopy C:\Scripts\GVPNRCF\connections.rcf "C:\Users\%username%\AppData\Roaming\Dell SonicWall\Global VPN Client\" /I /f /R /Y
xcopy C:\Scripts\GVPNRCF\backup.rcf "C:\Users\%username%\AppData\Roaming\Dell SonicWall\Global VPN Client\" /I /f /R /Y
